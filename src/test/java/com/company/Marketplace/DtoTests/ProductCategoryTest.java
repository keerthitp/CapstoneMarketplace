...
public class ProductCategoryTest {
    ...
    public  void shouldGetProductCategoryByName(){
        ...
        Assert.assertEquals("Toys",
                productCategoryRepo.getProductCategoryByProductCategoryName("Toys").getProductCategoryName());


        Assert.assertNull(
                productCategoryRepo.getProductCategoryByProductCategoryName("Cookware"));
    }
