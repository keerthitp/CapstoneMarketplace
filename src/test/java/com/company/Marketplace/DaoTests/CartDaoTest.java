...
//        shouldCreateCart();
    ...
    @Test
    @Transactional
    public void shouldUpdateCartWithProductRemoval(){
//        shouldCreateCart();
        ...
        // Going to remove product 2 from the cart
        cartProducts.remove(product2);
        cart1.setProducts(cartProducts);
        ...
        Assert.assertFalse(orderHistoryRepo.getOne(cart1.getCartId()).getProducts().contains(product2));
